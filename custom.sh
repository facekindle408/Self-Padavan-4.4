...
lan_ip="192.168.50"                                 # LAN 地址 别写后面的 .1
wlan_2g_ssid="nanana"                             # 2G 无线名称
wlan_5g_ssid="nanana_5G"                               # 5G 无线名称
wlan_guest_2g_ssid="nanana_pub_G"                   # 2G 访客无线名称
wlan_guest_5g_ssid="nanana_pub_5G"                     # 5G 访客无线名称
